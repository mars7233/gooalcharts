(function (global, factory) {
  ...
  var GooalCharts = function () {
      ...
      createClass(GooalCharts, [{
          ...
          value: function containerInit(dom) {
              var container = select(dom).append("svg").attr("width", this.width).attr("height", this.height).attr("class", "container");
              return container;
          }
      }, {
          key: "getContainer",
          ...
          key: "titleBoxInit",
          value: function titleBoxInit(titlebox) {
              var titleBox;
              return titleBox;
          }
      }, {
          ...
          key: "axisBoxInit",
          value: function axisBoxInit(axisbox) {
              var axisBox;
              return axisBox;
          }
      }, {
  ...
  function drawSimple(dom, options) {
    ...
    svg.append("g").attr("transform", "translate(" + 0 + "," + (h - padding.bottom) + ")").attr("class", "xAxis").call(xAxis);
    svg.append("g").attr("transform", "translate(" + padding.left + "," + padding.top + ")").attr("class", "yAxis").call(yAxis);
  ...
  var GooalColumn = function (_GooalCharts) {
      ...
      function GooalColumn(dom, options) {
          ...
          var _this = possibleConstructorReturn(this, (GooalColumn.__proto__ || Object.getPrototypeOf(GooalColumn)).call(this, dom, options));

          _this.width = _this.getWidth();
          _this.height = _this.getHeight();
          _this.container = _this.getContainer();
          _this.titleBox = _this.getTitleBox();
          _this.axisBox = _this.getAxisBox();
          _this.legendBox = _this.getLegendBox();
          _this.dataBox = _this.getDataBox();
          return _this;
      }
